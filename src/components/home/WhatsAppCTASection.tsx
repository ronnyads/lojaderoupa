    ...
    <section className="bg-ocean-gradient noise-texture py-16 lg:py-24 relative overflow-hidden">
      ...
      <div className="container relative z-10 text-center">
        ...
        <motion.h2
          ...
          className="font-display text-[clamp(2rem,5vw,3.5rem)] text-sand mb-4"
        >
          A ALOHA NO SEU ZAPP
        </motion.h2>
        <motion.p
          ...
          className="font-body text-sand/70 text-lg max-w-lg mx-auto mb-8"
        >
        ...
        <motion.p
          ...
          className="font-body text-sand/40 text-sm mt-4"
        >
